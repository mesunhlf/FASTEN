...
#所有的都是这样的，18，20，34，50，这里还是针对训练所作了改变，intermediata和before_relue
...
class ResNet(nn.Module):
    def __init__(self, depth, num_classes=10, leaky_relu=False):#主要cifar100有100类
        ...
        block = Bottleneck if depth >=44 else BasicBlock#18,20,34都用BasicBlock
