...
#https://github.com/zjysteven/DVERGE/tree/main/train
class ADP_Trainer():
    ...
    def train(self, epoch):
        ...
        for batch_idx, (inputs, targets) in enumerate(batch_iter):
            ...
            # one-hot label adjust when using different data
            num_classes = 10
...
def main():
    print("this is adp train")
    # get args
    args = get_args()

    # set up gpus
    os.environ["CUDA_VISIBLE_DEVICES"] = args.gpu
    print("this is gpu using:"+str(args.gpu))
